...
pub(crate) const APPLY_FILE_EDIT_ERROR_MARKER: &str = "__SSH_MCP_APPLY_FILE_EDIT_ERR__";
pub(crate) const APPLY_FILE_EDIT_CONFLICT_MARKER: &str = "__SSH_MCP_APPLY_FILE_EDIT_CONFLICT__";
pub(crate) const APPLY_FILE_EDIT_PREVIOUS_SHA_MARKER: &str =
    "__SSH_MCP_APPLY_FILE_EDIT_PREVIOUS_SHA__";
pub(crate) const APPLY_FILE_EDIT_NEW_SHA_MARKER: &str = "__SSH_MCP_APPLY_FILE_EDIT_NEW_SHA__";
pub(crate) const APPLY_FILE_EDIT_ACTUAL_SHA_MARKER: &str = "__SSH_MCP_APPLY_FILE_EDIT_ACTUAL_SHA__";
pub(crate) const APPLY_FILE_EDIT_BASELINE_SHA_MARKER: &str =
    "__SSH_MCP_APPLY_FILE_EDIT_BASELINE_SHA__";
pub(crate) const APPLY_FILE_EDIT_MISSING_SHA256: &str =
